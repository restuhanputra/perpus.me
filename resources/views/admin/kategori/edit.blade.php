...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
                <form action="{{ route('kategori-update', $data['kategori']->id) }}" method="post">
                    {{ csrf_field() }}

                    <div class="form-group row">
                        <label class="col-sm-3">Nama Kategori</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" name="nama" placeholder="Nama Kategori" value="{{ $data['kategori']->nama }}">
                            @if ($errors->has('nama'))
